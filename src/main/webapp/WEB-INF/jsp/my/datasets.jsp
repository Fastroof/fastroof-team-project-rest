                            ...
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <a type="button" href="/edit/dataset/<c:out value="${dataSet.id}"/>" class="btn btn-sm btn-outline-secondary">Редагувати</a>
                                        <a type="button" href="/delete/dataset/<c:out value="${dataSet.id}"/>" class="btn btn-sm btn-outline-danger">Видалити</a>
                                    </div>
                                </div>
                            </div>
                        </div>
